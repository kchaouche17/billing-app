...
| Q11 | **Le NAS est-il rempli pour (quasi) tous dans UKG ?** | Détermine la couverture du match automatique. | **Ouvert — à vérifier à l'extraction** (2026-07-29) | Le champ existe dans UKG ; sa complétude se vérifie à l'export UKG (Phase 3). |
